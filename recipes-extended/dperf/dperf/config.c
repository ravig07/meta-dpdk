...
static struct option g_options[] = {
    ...
    {"same_system", required_argument, NULL, 'p'},
...
int config_parse(int argc, char **argv, struct config *cfg, char *prefix_name[])
{
    int conf = 0;
    int opt = 0;
    int test = 0;
    const char *optstr = "p:hvtmc:";
